...
{
	BST<int> bst;
	bst.recursive_tree_insert(50);
	bst.recursive_tree_insert(30);
	bst.recursive_tree_insert(70);
	bst.recursive_tree_insert(10);
	bst.recursive_tree_insert(90);
	bst.recursive_tree_insert(100);
