...
{
    Binary_tree<int> t;
    auto n1 = std::make_unique<Binary_tree_node<int>>(6);
    auto n2 = std::make_unique<Binary_tree_node<int>>(5);
    auto n3 = std::make_unique<Binary_tree_node<int>>(7);
    auto n4 = std::make_unique<Binary_tree_node<int>>(2);
    auto n5 = std::make_unique<Binary_tree_node<int>>(5);
    auto n6 = std::make_unique<Binary_tree_node<int>>(8);
    ...
    t.root->right->right = std::move(n6);
    std::cout << t;
}
